...
$requests = [
    ...
    "content" => [
        ...
        "item" => [
            'customers' => [
                "menu" => $jatbi->lang("Khách hàng & NCC"),
                "url" => '/customers',
                "icon" => '<i class="ti ti-users-group "></i>',
                "sub" => [
                    'customers'      => [
                        "name"  => $jatbi->lang("Khách hàng"),
                        "router" => '/customers',
                        "icon"  => '<i class="ti ti-user"></i>',
                    ],
                    'customers.vendors'      => [
                        "name"  => $jatbi->lang("Nhà cung cấp"),
                        "router" => '/customers/vendors',
                        "icon"  => '<i class="ti ti-user"></i>',
                    ],
                    'customers.overview'    => [
                ...
                "permission" => [
                    ...
                    'customers.vendors' => $jatbi->lang("Nhà cung cấp"),
                    'customers.vendors.add' => $jatbi->lang("Thêm Nhà cung cấp"),
                    'customers.vendors.edit' => $jatbi->lang("Sửa Nhà cung cấp"),
                    'customers.vendors.deleted' => $jatbi->lang("Xóa Nhà cung cấp"),
        ...
        "item" => [
            ...
            'admin' => [
                ...
                "sub" => [
                    ...
                    'point' => [
                        "name" => $jatbi->lang("Tích điểm"),
                        "router" => '/admin/point',
                        "icon" => '<i class="fas fa-point"></i>',
                        "action" => 'modal',
                    ],
                    'flood' => [
                ...
                "permission" => [
                    ...
                    'coupons.add' => $jatbi->lang("Thêm Thẻ quà tặng"),
                    'coupons.edit' => $jatbi->lang("Sửa Thẻ quà tặng"),
                    'coupons.deleted' => $jatbi->lang("Xóa Thẻ quà tặng"),
